...
public class KitchenEventPublisher {
    ...
    public KitchenEventPublisher(
            KafkaTemplate<String, String> kafkaTemplate,
            ObjectMapper objectMapper,
            @Value("${KITCHEN_EVENTS_TOPIC:kitchen.events}") String topicName) {
